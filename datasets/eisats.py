...
class EISATSDataset(Dataset):
    def __init__(self, datapath, list_filename, training):
        self.datapath = datapath
        self.left_filenames, self.middle_filenames, self.right_filenames = self.load_path(list_filename)
    ...
    def load_path(self, list_filename):
        ...
        return left_images, middle_images, right_images
